    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="white-box bg-success">
                ...
                <ul class="list-inline two-part">
                    <li><i class="fa fa-money text-white"></i></li>
                    <li class="text-right"><span class="counter text-white">{{ $creditNote->currency->currency_symbol}} @if($paidAmount == 0){{ $creditNote->total }} @else {{ $paidAmount }} @endif</span></li>
                </ul>
            </div>
        </div>
        <div class="col-md-3">
            <div class="white-box bg-danger">
                ...
                <ul class="list-inline two-part">
                    <li><i class="fa fa-money text-white"></i></li>
                    <li class="text-right"><span class="counter text-white">{{ $creditNote->currency->currency_symbol}} @if($paidAmount == 0) 0 @else {{ max(($creditNote->total-$paidAmount),0) }} @endif</span></li>
                </ul>
            </div>
        </div>
        <div class="col-md-12">
