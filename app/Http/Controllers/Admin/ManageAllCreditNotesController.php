...
//        dd($this->paidAmount);
    ...
    public function export($startDate, $endDate, $projectID)
    {
        ...
        $creditNote = CreditNotes::join('projects', 'projects.id', '=', 'credit_notes.project_id')
            ->join('currencies', 'currencies.id', '=', 'credit_notes.currency_id')
            ->select('credit_notes.id', 'credit_notes.cn_number', 'projects.project_name', 'credit_notes.total', 'currencies.currency_symbol', 'credit_notes.issue_date');
        ...
        $creditNote = $creditNote->get()->makeHidden($attributes);
        ...
        $exportArray[] = ['ID', 'CreditNoteID', 'Project', 'Total', 'Invoice Date'];
        ...
        Excel::create('creditNote', function ($excel) use ($exportArray) {
