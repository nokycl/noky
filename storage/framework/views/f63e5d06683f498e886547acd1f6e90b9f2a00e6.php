        ...
        <div class="col-md-12">
            <div class="white-box">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <a href="<?php echo e(route('admin.all-tasks.create')); ?>" class="btn btn-outline btn-success btn-sm"><?php echo app('translator')->getFromJson('modules.tasks.newTask'); ?> <i class="fa fa-plus" aria-hidden="true"></i></a>
                            <a href="<?php echo e(route('admin.taskboard.index')); ?>" class="btn btn-inverse btn-sm"><i class="ti-layout-column3" aria-hidden="true"></i> <?php echo app('translator')->getFromJson('modules.tasks.taskBoard'); ?></a>
                            <a href="javascript:;" id="createTaskCategory" class="btn btn-outline btn-info btn-sm"><?php echo app('translator')->getFromJson('modules.taskCategory.addTaskCategory'); ?> <i class="fa fa-plus" aria-hidden="true"></i></a>
...
<script>
    ...
    function showTable() {
        ...
        var url = '<?php echo route('admin.all-tasks.data', [':startDate', ':endDate', ':hideCompleted', ':projectId']); ?>?clientID='+clientID +'&assignedBY='+ assignedBY+'&assignedTo='+ assignedTo+'&status='+ status+'&_token=<?php echo e(csrf_token()); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/tasks/index.blade.php ENDPATH**/ ?>